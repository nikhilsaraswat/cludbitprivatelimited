...
const slides = [{src:aiml,alt:"artificial intelligence and machine learning"}, {src:ml, alt:"machine learning"}, {src:chatbots, alt:"chatbots"}];
export default function machinelearningandartificialintelligence({posts, faq}) {
    return(
    <>
    <Head>
        <title>Machine Learning and Artificial Intelligence - CLUDBIT PRIVATE LIMITED</title>
        <meta name="description" content="OFFERING VARIOUS SERVICES IN Machine Learning and Artificial Intelligence (including chatbots)" />
        <meta property="og:title" content="Machine Learning and Artificial Intelligence - Cludbit Private Limited"/>
        <meta property="og:description" content="OFFERING VARIOUS SERVICES IN Machine Learning and Artificial Intelligence (including chatbots)" />
        <meta property="og:url" content="https://www.cludbit.com/machine-learning-and-artificial-intelligence"/>
        <meta property="og:type" content="website"/>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name='keywords' content='Artificial Intelligence, Machine Learning, Chatbots, Android development, web development, ios development, hybrid application development, data analytics, data engineering, AI, ML, data management, security management, digital marketting'/>
...
export async function getServerSideProps(ctx) {
  ...
  let response = await fetch(`${dev ? DEV_URL : PROD_URL}/api/mlai`);
  // extract the data
  let data = await response.json();

  // request posts from api
  let responses = await fetch(`${dev ? DEV_URL : PROD_URL}/api/mlai`);
  // extract the data
